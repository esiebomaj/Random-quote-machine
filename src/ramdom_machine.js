...
const heart = <FontAwesomeIcon icon={faHeart} id='tweet' size='1x' color='red' />

class Machine extends Component{
    state={
        color:'',
        quoteList:[{'author': 'Walt Disney',
       ...
       {'author': 'Michael Phelps',
        ...
        currentQuote:{author:'JeremAIh', quote:'I can build anything as long as Google is with me'}
    }

    NewQuote(e){
        console.log('I have been clicked')
        this.setState((prevState) => ({color:getRandomColor(), currentQuote:prevState.quoteList[Math.floor(Math.random() * 30)]}))       
        ...
        return (
            <div id='machine' style={{backgroundColor:this.state.color}}>
                ...
                <div style={{color:this.state.color}} id='quote-box'>
                    <div id='text'> 
                        <p><span style={{fontSize:'2.5em', fontWeight:1000}}>"</span>{this.state.currentQuote.quote}</p>
                    </div>
                    <div id='author'> 
                        <p><span>- </span>{this.state.currentQuote.author}</p>
                    </div>
                    <div id='actions'> 
                        <div id='tweet-quote'> 
                        <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" className="twitter-share-button" data-size="large" data-text={this.state.currentQuote.quote + '\n'+' by '+this.state.currentQuote.author+'\n'} data-hashtags="jeremAIh" data-show-count="false">{tweet}</a>
                        
                        </div>
                        <div id='new-quote'> 
                            <button style={{backgroundColor:this.state.color}} onClick={(e)=>this.NewQuote(e)}>New Quote</button>
                        </div>
                    </div>
